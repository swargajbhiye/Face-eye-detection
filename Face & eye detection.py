...
face_classifier = cv2.CascadeClassifier(r"E:\eye detection\haarcascade_frontalface_default.xml")
eye_classifier = cv2.CascadeClassifier(r"E:\eye detection\haarcascade_eye.xml")

# Load the image
#img = cv2.imread(r"E:\eye detection\swar .jpg")
img = cv2.imread(r"E:\eye detection\sample img.webp")
